...
import {
  Container, Row, Col, Form, InputGroup ,Modal , Button, Navbar, Nav,
...
function Home() 
{
  return (
   <div className="body">   
    ...
    <p className="font-montserrat fw-bold fs-26">Aloha
    <span className="text-black-50 fw-light">Technology</span>
    </p>      
    </div>
    <hr className="hr"/>
    <div className="text-end py-12p">
    <div className="d-inline-block px-12p ico" id="search-ico">
    ...
    <div className="vl d-none d-md-block mt-3 margin-left" ></div>
